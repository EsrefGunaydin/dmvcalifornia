...
#ifndef DMVCALIFORNIA_SWIFT_H
#define DMVCALIFORNIA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DMVCalifornia",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
SWIFT_CLASS("_TtC13DMVCalifornia11AppDelegate")
@interface AppDelegate : NSObject <UIApplicationDelegate>
- (BOOL)application:(UIApplication * _Nonnull)application didFinishLaunchingWithOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC13DMVCalifornia21InterstitialAdManager")
@interface InterstitialAdManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@protocol GADFullScreenPresentingAd;
@interface InterstitialAdManager (SWIFT_EXTENSION(DMVCalifornia)) <GADFullScreenContentDelegate>
...
SWIFT_CLASS("_TtC13DMVCalifornia17NativeAdViewModel")
@interface NativeAdViewModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class GADAdLoader;
@interface NativeAdViewModel (SWIFT_EXTENSION(DMVCalifornia)) <GADAdLoaderDelegate>
- (void)adLoader:(GADAdLoader * _Nonnull)adLoader didFailToReceiveAdWithError:(NSError * _Nonnull)error;
@end

@class GADNativeAd;
@interface NativeAdViewModel (SWIFT_EXTENSION(DMVCalifornia)) <GADNativeAdLoaderDelegate>
