        ...
        <section className="container mx-auto px-4 py-12">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl border-2 border-orange-100 shadow-sm p-6 text-center">
              <h3 className="text-xl font-bold text-gray-900 mb-2 flex items-center justify-center gap-2"><Navigation className="w-5 h-5 text-orange-600" /> हिन्दी रोड साइन टेस्ट</h3>
