      ...
      <section className="bg-gradient-to-r from-primary to-primary-600 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-6 flex flex-wrap gap-3 text-sm">
            ...
            <a href={`tel:${DMV_PHONE.replace(/-/g, '')}`} className="bg-white/20 px-4 py-2 rounded-full hover:bg-white/30 flex items-center gap-1.5">
              <Phone className="w-4 h-4" /> {DMV_PHONE}
            </a>
