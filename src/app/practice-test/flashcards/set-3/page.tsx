...
import flashcardsData from '@/data/flashcards-3.json';
import Link from 'next/link';

export const metadata: Metadata = {
  title: 'DMV California Practice Flashcards - Set 3 | DMV California',
  description: '15 essential DMV questions covering lane changes, U-turns, cargo rules, and school zones for California driving test preparation.',
  keywords: ['DMV flashcards', 'California driving test', 'DMV practice', 'study flashcards', 'lane changes', 'U-turns', 'school zones'],
  openGraph: {
    title: 'DMV California Practice Flashcards - Set 3',
    description: '15 essential DMV questions covering lane changes, U-turns, cargo rules, and school zones',
    type: 'website',
  }
};

export default function FlashcardsSet3Page() {
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex justify-center mt-5">
                <QuizViewTracker
                  quizId="flashcards-set-3"
                  baseViews={getBaseViews('flashcards-set-3')}
                  variant="prominent"
        ...
        <section className="py-12">
          <div className="container mx-auto px-4">
            <FlashcardDeck
              ...
              deckId="set-3"
              nextSet={{ href: '/practice-test/flashcards/set-4', title: 'Set 4 — Peace officers & parking' }}
            />
          </div>
        </section>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                >
                  ...
                  <p className="text-gray-700 text-sm">
                    Questions 1-15: BAC limits, turning signals
                  </p>
                </Link>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-purple-50 rounded-lg p-6">
                  <div className="w-10 h-10 rounded-lg bg-purple-100 flex items-center justify-center mb-3"><RefreshCw className="w-5 h-5 text-purple-600" /></div>
