...
import flashcardsData from '@/data/flashcards-4.json';
import Link from 'next/link';

export const metadata: Metadata = {
  title: 'DMV California Practice Flashcards - Set 4 | DMV California',
  description: '12 essential DMV questions covering peace officers, medications, crossing guards, and parking rules for California driving test preparation.',
  keywords: ['DMV flashcards', 'California driving test', 'DMV practice', 'study flashcards', 'peace officers', 'medications', 'parking rules'],
  openGraph: {
    title: 'DMV California Practice Flashcards - Set 4',
    description: '12 essential DMV questions covering peace officers, medications, crossing guards, and parking rules',
    type: 'website',
  }
};

export default function FlashcardsSet4Page() {
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex justify-center mt-5">
                <QuizViewTracker
                  quizId="flashcards-set-4"
                  baseViews={getBaseViews('flashcards-set-4')}
                  variant="prominent"
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-orange-50 rounded-lg p-6">
                  <div className="w-10 h-10 rounded-lg bg-orange-100 flex items-center justify-center mb-3"><RefreshCw className="w-5 h-5 text-orange-600" /></div>
