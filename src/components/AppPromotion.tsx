          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-white/90 text-sm md:text-base">
                Practice anytime, anywhere with 1,164+ questions in 11 languages, flashcards, and offline access
              </p>
            </div>
          </div>
          <a
    ...
    <div className={`bg-gradient-to-br from-orange-50 to-white border-2 border-primary-200 rounded-xl shadow-lg overflow-hidden ${className}`}>
      <div className="p-6">
        ...
        <p className="text-gray-700 text-sm mb-4 leading-relaxed">
          Take your DMV practice anywhere! Download our app for offline access, flashcards, and 1,164+ practice questions in 11 languages.
        </p>
