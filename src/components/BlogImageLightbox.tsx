  ...
  return (
    ...
    >
      <button
        ...
        className="absolute top-4 right-4 w-11 h-11 rounded-full bg-white text-gray-900 flex items-center justify-center shadow-2xl hover:bg-gray-100 transition-colors"
      >
