...
export default function PushPermissionPrompt({ streak }: PushPermissionPromptProps) {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 sm:left-auto sm:right-6 sm:w-96 z-50 bg-white rounded-2xl shadow-2xl border border-gray-200 p-5">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex gap-2">
            <button
              onClick={handleAllow}
              className="flex-1 bg-primary text-white text-sm font-semibold px-4 py-2 rounded-lg hover:bg-primary/90 transition-colors"
            >
              Allow
            </button>
            <button
